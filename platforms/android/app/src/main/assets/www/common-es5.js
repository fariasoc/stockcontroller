...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /*! exports provided: AtivoLDCService */

  /***/
  function srcAppServicesAtivoLdcServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AtivoLDCService", function () {
      return AtivoLDCService;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function AtivoLDCService(afs) {
        _classCallCheck(this, AtivoLDCService);
        ...
        this.data = [{
          ...
          products: [{
            ...
            id: 2,
            name: 'Tanque de Tocoferol',
            tag: '009'
          }, {
            id: 3,
            name: 'Tanque de degomaodo',
            tag: '007'
          }]
        }, {
          ...
          products: [{
            ...
            id: 7,
            name: 'Barracão de casca',
            tag: '002'
          }, {
            id: 8,
            name: 'Barracão de resíduo',
            tag: '003'
          }]
        }, {
          category: 'Portaria',
        ...
        this.ativoCollection = this.afs.collection('ativos');
        this.ativos = this.ativoCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
        ...
        this.reuniaoCollection = this.afs.collection('reunioes');
        this.reunioes = this.reuniaoCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (actions) {
          return actions.map(function (a) {
            var data = a.payload.doc.data();
            var id = a.payload.doc.id;
            return Object.assign({
      ...
      _createClass(AtivoLDCService, [{
        key: "getReunioes",
        value: function getReunioes() {
          return this.reunioes;
        }
      }, {
        key: "getAtivos",
        value: function getAtivos() {
          return this.ativos;
        }
      }, {
        key: "getReuniao",
        value: function getReuniao(id) {
          return this.reuniaoCollection.doc(id).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (reuniao) {
            reuniao.id = id;
            return reuniao;
          }));
        }
        ...
        key: "getAtivo",
        value: function getAtivo(id) {
          return this.ativoCollection.doc(id).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (ativo) {
            ativo.id = id;
            return ativo;
          }));
        }
        ...
        key: "addAtivo",
        value: function addAtivo(ativo) {
          return this.ativoCollection.add(ativo);
        }
      }, {
        key: "addReuniao",
        value: function addReuniao(reuniao) {
          return this.reuniaoCollection.add(reuniao);
        }
      }, {
        key: "updateReuniao",
        value: function updateReuniao(reuniao) {
          return this.reuniaoCollection.doc(reuniao.id).update({
            dia: reuniao.dia,
            setor: reuniao.setor,
            anotacao: reuniao.anotacao,
        ...
        key: "updateAtivo",
        value: function updateAtivo(ativo) {
        ...
        key: "updateStatus",
        value: function updateStatus(ativo) {
          return this.ativoCollection.doc(ativo.id).update({
            status: ativo.status
          });
        }
        ...
        key: "deleteReuniao",
        value: function deleteReuniao(id) {
          return this.reuniaoCollection.doc(id).delete();
        }
      }, {
        key: "deleteAtivo",
        value: function deleteAtivo(id) {
          return this.ativoCollection.doc(id).delete();
        }
      }, {
        key: "getdadosFake",
        value: function getdadosFake() {
          return this.data;
        }
      }]);
    ...
    AtivoLDCService.ctorParameters = function () {
      return [{
        type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]
      }];
    };

    AtivoLDCService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"]])], AtivoLDCService);
    /***/
  }
}]);
