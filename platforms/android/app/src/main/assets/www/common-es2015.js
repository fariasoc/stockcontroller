...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AtivoLDCService", function() { return AtivoLDCService; });
...
let AtivoLDCService = class AtivoLDCService {
    constructor(afs) {
        this.afs = afs;
        this.data = [
            {
        ...
        this.ativos = this.ativoCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
        ...
        this.reunioes = this.reuniaoCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
            return actions.map(a => {
                const data = a.payload.doc.data();
                const id = a.payload.doc.id;
                return Object.assign({ id }, data);
    ...
    getReuniao(id) {
        return this.reuniaoCollection.doc(id).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(reuniao => {
            reuniao.id = id;
            return reuniao;
        }));
    }
    getAtivo(id) {
        return this.ativoCollection.doc(id).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(ativo => {
            ativo.id = id;
            return ativo;
        }));
    }
    ...
    updateAtivo(ativo) {
        return this.ativoCollection.doc(ativo.id).update({ nome: ativo.nome, setor: ativo.setor,
            lacre_num: ativo.lacre_num, status: ativo.status });
    }
    updateStatus(ativo) {
...
AtivoLDCService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
AtivoLDCService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
